...
if __name__ == '__main__':
    ...
    images.append(axes[2, 0].imshow(read_matrix(os.path.join(example_path, "Uvych_normal_re.xls")), cmap="jet"))
    axes[2, 0].set_title("Uvych_normal_re")
    images.append(axes[2, 1].imshow(read_matrix(os.path.join(example_path, "Uvych_normal_im.xls")), cmap="jet"))
    axes[2, 1].set_title("Uvych_normal_im")
    images.append(axes[2, 2].imshow(read_matrix(os.path.join(example_path, "Uvych_normal_abs.xls")), cmap="jet"))
    axes[2, 2].set_title("Uvych_normal_abs")


    images.append(axes[3, 0].imshow(read_matrix(os.path.join(example_path, "Uvych_noised_re.xls")), cmap="jet"))
    axes[3, 0].set_title("Uvych_noised_re")
    images.append(axes[3, 1].imshow(read_matrix(os.path.join(example_path, "Uvych_noised_im.xls")), cmap="jet"))
    axes[3, 1].set_title("Uvych_noised_im")
    images.append(axes[3, 2].imshow(read_matrix(os.path.join(example_path, "Uvych_noised_abs.xls")), cmap="jet"))
    axes[3, 2].set_title("Uvych_noised_abs")

    images.append(axes[4, 0].imshow(read_matrix(os.path.join(example_path, "Uvych_re.xls")), cmap="jet"))
    axes[4, 0].set_title("Uvych_re")
    images.append(axes[4, 1].imshow(read_matrix(os.path.join(example_path, "Uvych_im.xls")), cmap="jet"))
    axes[4, 1].set_title("Uvych_im")
    images.append(axes[4, 2].imshow(read_matrix(os.path.join(example_path, "Uvych_abs.xls")), cmap="jet"))
    axes[4, 2].set_title("Uvych_abs")

    images.append(axes[5, 0].imshow(read_matrix(os.path.join(example_path, "K_inv_re.xls")), cmap="jet"))
    axes[5, 0].set_title("K_inv_re")
    images.append(axes[5, 1].imshow(read_matrix(os.path.join(example_path, "K_inv_im.xls")), cmap="jet"))
    axes[5, 1].set_title("K_inv_im")
    images.append(axes[5, 2].imshow(read_matrix(os.path.join(example_path, "K_inv_abs.xls")), cmap="jet"))
    axes[5, 2].set_title("K_inv_abs")
