...
pub fn calculate_matrix_col(N: usize, num_x: usize, num_y: usize, point: usize, n_x: usize, n_y: usize,
                            ip1: usize, ip2: usize, dim_x: f64, dim_y: f64, a: f64, b: f64, k: &mut Vec<Complex64>,
...
pub fn integral_col(flag: usize, num_x: usize, num_y: usize, dim_x: f64, dim_y: f64, a: f64, b: f64, ip1: usize, xx1: f64, xx2: f64, xvv: f64, yvv: f64, k0: Complex64) -> Complex64 {
    ...
    let mut ret: Complex64 = Complex64::new(0.0, 0.0);
    let mut s: Complex64 = Complex64::new(0.0, 0.0);
    let mut x1: f64;
    let mut x2: f64;
    let mut x3: f64;
    let mut hx1: f64;
    ...
    if flag == 0 {
        ...
        ret = s * Complex64::new(hx1, 0.0) * Complex64::new(hy1, 0.0);
    } else {
